...
def display():
    ...
    var.screen.blit(asset.Font.neodgm_32.render('Card', False, const.Color.black), UI.Title.text_title)
    ...
    var.screen.blit(asset.Font.neodgm_32.render('Erase', False, const.Color.black), UI.Title.text_erase)
